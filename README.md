...
scanpy v1.11.1 or one of the older versions where the original conga code was tested,
for example v1.4.3. Will update here when this is figured out. Thanks for your patience!
